...
const App = () => {
  ...
  const hideSidebarRoutes = ["/facilitymaster", "/apartmentmaster", "/locationmaster", "/categorymaster", "/subcategorymaster", "/", "/ApartmentMicrosite","/notfound","/error"]; // add to avoid sidebar
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <Box component="main" sx={{ flex: 1, overflow: "auto" }}>
            <Routes>
              ...
              <Route path="/facilitymaster" element={<ProtectedRoute><FacilityMaster empId="C2064" /></ProtectedRoute>} />
              ...
              <Route path="/ApartmentQRModal" element={<ProtectedRoute><ApartmentQRModal /></ProtectedRoute>} />
